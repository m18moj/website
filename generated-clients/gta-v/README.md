...
The in-game menu that ties the ScriptForge GTA V script pack together. It doesn't add new
...
Both of these are third-party community tools, not made by ScriptForge. Grab them from their
...
## Installing ForgeClient + your ScriptForge pack
...
3. Copy every `.cs` file from your purchased ScriptForge GTA V pack into that same `Scripts`
...
documented, supported way each ScriptForge script opts into being controlled by this menu.
...
Questions about the pack or this menu can go through the ScriptForge marketplace listing you
purchased from.
