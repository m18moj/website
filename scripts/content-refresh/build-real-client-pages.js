...
function buildPage(client) {
  ...
  const gamePageHref = `../games/${client.sourcePage}`;
...
<body data-root-prefix="../">
    ...
    <main class="page-shell">
        <div class="container breadcrumbs" aria-label="Breadcrumb">
            <a href="../index.html">Home</a> / <a href="games.html">Games</a> / <a href="${gamePageHref}">${escapeHtml(client.displayName)}</a> / <span>Client</span>
        </div>
